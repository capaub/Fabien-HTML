    ...
    <form action="?page=<?php echo PAGE_LOGIN; ?>" method="POST" class="form_login">
        <fieldset>
            ...
            <div>
                ...
                <input type="text" name="field_login_username" id="field_login_username" required>
            </div>
            <div>
                <label for="field_login_password">Password</label>
                <input type="password" name="field_login_password" id="field_login_password" required>
            </div>
            <div>
