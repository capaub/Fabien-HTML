        ...
        <?php foreach ($articles as $oArticle) : ?>
            <article class="col-3 bg-light rounded-1 mx-3 p-4 container">
                ...
                <ul class="align-content-around">
                    ...
                    <li class="col-6 list-unstyled">Status : <?= $oArticle::STATUS[$oArticle->getStatus()] ?></li>
                    <li class="col-6 list-unstyled">Date de création
                        : <?= $oArticle->getCreatedAt()->format('Y-m-d') ?></li>
                </ul>
